...
describe('mobiledoc/read-time-computed-field', function() {
  ...
  async function setup () {
    ...
    article1 = factory.addResource('articles', '1')
      .withAttributes({
        text: articleBody
      });
    ...
    article2 = factory.addResource('articles', '2')
      .withAttributes({
