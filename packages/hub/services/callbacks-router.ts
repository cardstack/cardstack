...
export default class CallbacksRouter {
  wyreCallbackRoute: WyreCallbackRoute = inject('route:wyre-callback', { as: 'wyreCallbackRoute' });
  checklyWebhookRoute = inject('route:checkly-webhook', { as: 'checklyWebhookRoute' });
