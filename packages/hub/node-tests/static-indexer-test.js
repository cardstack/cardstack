...
describe('static-models indexers', function() {
  ...
  describe('valid schema', function() {
    ...
    it('can rely on static content', async function() {
      factory.addResource('content-types', 'other-things').withRelated('fields', [
        factory.addResource('fields', 'title-of-thing').withAttributes({
  ...
  it.skip('does not allow static-model data source to contain schema', async function() {
    ...
    expect(error.message).to.match(
      /defines static-models that includes schema. Schema is not allowed in static-models. Found schema models: \["content-types\/bananas"\]/
    );
  });
});
