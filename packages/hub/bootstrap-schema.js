...
const models = [
  ...
  },
  {
    ...
    relationships: {
      fields: {
        data: [{ type: 'fields', id: 'search-query' }],
      },
    },
  },
  {
  ...
  },
  {
    ...
    relationships: {
      'related-types': {
        data: [
          { type: 'content-types', id: 'fields' },
          { type: 'content-types', id: 'computed-fields' },
        ],
      },
    },
  },
