...
const privateKey = fs_1.readFileSync(path_1.join(__dirname, 'git-ssh-server', 'cardstack-test-key'), 'utf8');
...
//# sourceMappingURL=indexer-remote-test.js.map