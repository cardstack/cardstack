...
let rotatedAndCroppedImageDataUri =
  'data:image/png;base64,';
...
module('Integration | Component | image-editor', function (hooks) {
  ...
  test('it can edit an image, preview it, and save it', async function (assert) {
    let result: string = '';
    this.set('saveImageEditData', (data: { image: string }) => {
      result = data.image;
    });
    ...
    assert.equal(result, rotatedAndCroppedImageDataUri);
  });
});
