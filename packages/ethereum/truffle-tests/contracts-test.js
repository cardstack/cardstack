    ...
    describe('ethereum-indexer', function () {
      ...
      it("indexes mapping entry, keyed by address, content types when a contract fires an ethereum event", async function () {
        try {
          ...
          expect(err.message).to.equal(`No such resource sample-token-balance-ofs/${accountOne}`);
        }
        ...
        try {
          ...
          expect(err.message).to.equal(`No such resource sample-token-balance-ofs/${accountTwo}`);
        }
      ...
      it("indexes mapping entry content with different field types for the same event", async function () {
        try {
          ...
          expect(err.message).to.equal(`No such resource sample-token-custom-buyer-limits/${accountOne}`);
        }
        ...
        try {
          ...
          expect(err.message).to.equal(`No such resource sample-token-approved-buyers/${accountOne}`);
        }
        ...
        try {
          ...
          expect(err.message).to.equal(`No such resource sample-token-custom-buyer-limits/${accountTwo}`);
        }
        ...
        try {
          ...
          expect(err.message).to.equal(`No such resource sample-token-approved-buyers/${accountTwo}`);
        }
