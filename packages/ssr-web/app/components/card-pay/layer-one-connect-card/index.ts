...
import walletProviders from '@cardstack/ssr-web/utils/wallet-providers';

import cardstackLogo from '@cardstack/ssr-web/images/icons/cardstack-logo-navy-rounded.svg';
import connectionSymbol from '@cardstack/ssr-web/images/icons/connection-symbol.svg';
