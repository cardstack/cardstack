...
import CardSpaceLogo from '@cardstack/ssr-web/images/icons/card-space-logo-clear-background.svg';
import CardPayLogo from '@cardstack/ssr-web/images/icons/card-pay-logo.svg';
import CardMembershipLogo from '@cardstack/ssr-web/images/icons/card-membership-logo.svg';
import CardCatalogLogo from '@cardstack/ssr-web/images/icons/card-catalog-logo.svg';

import CardSpaceImage from '@cardstack/ssr-web/images/illustrations/card-space-illustration.svg';
import CardPayImage from '@cardstack/ssr-web/images/illustrations/card-pay-illustration.svg';
import CardCatalogImage from '@cardstack/ssr-web/images/illustrations/card-catalog-illustration.svg';
import CardMembershipImage from '@cardstack/ssr-web/images/illustrations/card-membership-illustration.svg';
import CardSpaceHor from '@cardstack/ssr-web/images/illustrations/card-space-illustration-horizontal.svg';
import CardPayHor from '@cardstack/ssr-web/images/illustrations/card-pay-illustration-horizontal.svg';
import CardCatalogHor from '@cardstack/ssr-web/images/illustrations/card-catalog-illustration-horizontal.svg';
import CardMembershipHor from '@cardstack/ssr-web/images/illustrations/card-membership-illustration-horizontal.svg';

import '@cardstack/ssr-web/css/cardstack-landing-page.css';
