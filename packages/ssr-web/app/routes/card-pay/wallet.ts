...
import heroImageUrl from '@cardstack/ssr-web/images/dashboard/balances-hero.svg';
import summaryHeroImageUrl from '@cardstack/ssr-web/images/dashboard/balances-summary-hero.svg';
