...
import heroImageUrl from '@cardstack/ssr-web/images/dashboard/suppliers-hero.svg';
import summaryHeroImageUrl from '@cardstack/ssr-web/images/dashboard/suppliers-summary-hero.svg';
