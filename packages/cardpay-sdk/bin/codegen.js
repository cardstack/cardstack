...
for (const p of paths) {
  ...
  const abiJson = eval(cleanAbiInput(abiContents));
...
writeFileSync(
  generatedFile,
  `// @ts-nocheck
// This file is auto-generated by bin/codegen.js
// Language: typescript
...
function cleanAbiInput(abiContents) {
  return abiContents.replace('export default ', '').replace('function noop() {};', '').replace('noop();', '');
}
