...
function initialModels() {
  ...
  initial
    .addResource('content-types', 'drivers')
    .withAttributes({
      defaultIncludes: ['feeling', 'vehicle', 'alternate-vehicle'],
    })
    .withRelated('fields', [
  ...
  initial
    .addResource('drivers', 'metalmario')
    .withAttributes({
      name: 'Metal Mario',
      dob: '1999-01-01',
