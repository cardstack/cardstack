...
class TestFlatPayment:
    @pytest.mark.parametrize(
        ...
        [
            ...
            ((1024, 100 * 1_000_000_000_000_000_000, ["0x41149498EAc53F8C15Fe848bC5f010039A130963"]), 1),
            ((1024, 100 * 1_000_000_000_000_000_000, ["0x41149498EAc53F8C15Fe848bC5f010039A130963", "0x76271cb51c7e5C0F0E9d2f1e4d6DFCD621e99eB7"]), 2),
        ],
        indirect=["rule"],
    )
    def test_pays_all(self, rule, expected_payees, indexed_data):
        ...
        assert pytest.approx(computed_summary["total_reward"][0]) == expected_payees * 100 * 1_000_000_000_000_000_000