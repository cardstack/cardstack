...
module.exports = function({ dataSource, provideUserSchema }) {
  ...
  if (dataSource.userRewriter) {
    log.warn(
      'If you use a custom user-rewriter on the github-auth data source, you should probably also set params.provideUserSchema=false and provide your own user model',
    );
  }
