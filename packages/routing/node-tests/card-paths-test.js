...
describe('routing/paths', function() {
  ...
  describe('getPath() with router that has :friendly_id based route and vanity route', function() {
    ...
    beforeEach(async function() {
      ...
      card = factory.addResource('puppies', 'vanGogh').withAttributes({
        name: 'VanGogh',
      });
  ...
  describe('getPath() with non canonical routing', function() {
    ...
    beforeEach(async function() {
      ...
      applicationCard = factory.addResource('docs', 'app').withAttributes({
        'dog-breed': 'dalmatian',
      });
  ...
  describe('routing card is mounted below the application card', function() {
    ...
    beforeEach(async function() {
      ...
      factory
        .addResource('content-types', 'routing-cards')
        .withAttributes({
          router: [
            {
              path: '/:puppy-id',
      ...
      let routingCard = factory.addResource('routing-cards', 'routeA').withAttributes({ name: 'Route A' });
  ...
  describe('routing card is derived from query that uses :card:data', function() {
    ...
    beforeEach(async function() {
      ...
      let routingCard = factory
        .addResource('routing-cards', 'routeA')
        .withAttributes({ name: 'Route A', 'puppy-type': 'puppies' });

      factory
        .addResource('content-types', 'deep-routing-cards')
        .withAttributes({
          router: [
            {
              path: '/routing/:router-id',
      ...
      let deepRoutingCard = factory
        .addResource('deep-routing-cards', 'route1')
