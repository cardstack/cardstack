...
function initialModels() {
  ...
  initial.addResource('content-types', 'pages').withRelated('fields', [
  ...
  initial.addResource('pages', 'page-homepage').withAttributes({
    blurb: 'this is the homepage',
    permalink: ' ',
  });
  initial.addResource('pages', 'page-second').withAttributes({
  ...
  initial
    .addResource('content-types', 'categories')
    .withAttributes({
  ...
  initial
    .addResource('categories', 'category-1')
    .withAttributes({
      title: 'test category',
    })
    .withRelated('posts', [
