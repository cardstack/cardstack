...
factory
  .addResource('content-types', 'cs-files')
  .withRelated('fields', [
...
factory
  .addResource('content-types', 'images')
  .withAttributes({
  ...
  .withRelated('fields', [
    ...
    factory
      .addResource('fields', 'file')
      .withAttributes({
        'field-type': '@cardstack/core-types::belongs-to',
      })
      .withRelated('relatedTypes', [{ type: 'content-types', id: 'cs-files' }]),
  ]);
...
factory
  ...
  .withRelated('fields', [
    ...
    factory
      ...
      .withRelated('relatedTypes', [{ type: 'content-types', id: 'images' }]),
  ]);
