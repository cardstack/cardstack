...
export default class MediaRegistryIndexRoute extends Route {
  ...
  async model() {
    ...
    return {
      ...
      title: currentOrg.musicalWorkOnly ? 'Musical Works' : 'Master Recordings',
      type: 'collection',
      collection: tracks,
      itemType: currentOrg.musicalWorkOnly ? 'work' : 'master',
      itemTypePlural: currentOrg.musicalWorkOnly ? 'works' : 'masters',
