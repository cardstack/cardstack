  ...
  messages: [
    {
      ...
      datetime: '2020-09-21T20:12',
      content:
        'You have placed an order for an item that requires a manual inventory check. Your credit card has not been charged. If the products are in stock, we will reserve them for you and proceed to the payment process. You will receive status updates via email and in this thread.',
    },
    {
      id: '1',
      orgId: 'spw',
